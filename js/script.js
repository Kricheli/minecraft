...
const inventory = {
        ...
        resetInventory(){
                const numOfInventoryBoxes = window.matchMedia(`only screen and (max-width: 850px) and (orientaion:portrait)`).matches ? 4:8;
                this.inventoryElement.innerHTML = `<div class="inventory__box --border-color-secondary" data-type="empty"></div>`.repeat(numOfInventoryBoxes);
                inventory.boxes = [];
...
const tools = {
        axe: {
                url: './images/images/tools/treeAxeCursor.png',
                blocks: ['leaf', 'log']
        },
        shovel: {
                url: './images/images/tools/stoneCursor.png',
                blocks: ['stone']
        },
        pickaxe: {
                url: './images/images/tools/dirtShovelCursor.png',
                blocks: ['dirt']
        },
        hoe: {
                url: './images/images/tools/hayHoeCursor.png',
                blocks: ['hay']
        }
};
...
const blocks = {
        dirt: {
                ...
                url: './images/images/blocks/dirtBlock.png',   
        },
        tree: {
                height: 9,
                width: 8,
        ...
        leaf: {
                url: './images/images/blocks/leafBlock.png',
              },
              log: {
                url: './images/images/blocks/logBlock.png',
              },
}
// ------------------------------------------------------------------------------------------
